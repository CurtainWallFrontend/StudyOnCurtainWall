...
urlpatterns = [
    ...
    path('vibration/getDevice/',Test.as_view({'get':'get_device'})),
    path('vibration/addDevice/', Test.as_view({'get': 'add_device'})),
    path('vibration/deleteDevice/', Test.as_view({'get': 'delete_device'}))
]
