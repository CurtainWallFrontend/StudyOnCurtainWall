...
SECRET_KEY = "django-insecure-)a3ijn5&myc0%t7fnpif*_npl05hqtvw1ky$3_6(3xy)9^#8(m"
...
AUTHENTICATION_BACKENDS = [
    'custom_auth_backends.CustomUserAuthBackend',  # 自定义认证后端的路径
    'django.contrib.auth.backends.ModelBackend',  # 默认的Django认证后端
]
